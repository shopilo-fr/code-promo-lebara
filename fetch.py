#!/usr/bin/env python3
"""
Recuperation des codes promo Lebara depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/lebara.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/lebara.fr"
STORE_NAME = "Lebara"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Lebara depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-lebara)"
    }
    try:
